import './Savings.css';
import { iconsImgs, personsImage } from '../../utils/images';
              ...
              <div className='grid-item' key = {saving.id}>
                <div className='grid-item-top'>
                  <div className='grid-item-top-l'>
                    <div className='avatar img-fit-cover'>
                      <img src={personsImage.person_one} />
                    </div>
                ...
                <div className='grid-item-bottom'>
                  <div className='grid-item-badges'>
                    <span className='grid-item-badge'>Date taken 
                    {saving.date_taken}</span>
                    <span className='grid-item-badge'>Amount left $
                    {saving.amount_left}</span>
                  </div>
